...
import { getTransactionsCoin, getTransactionsData } from '../../model/selectrors/getTransactionsData';
...
export const TransactionsList = React.memo(({ assets }: TransactionsListProps) => {
