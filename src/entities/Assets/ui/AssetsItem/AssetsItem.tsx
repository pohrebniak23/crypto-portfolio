...
export const AssetsItem = React.memo(({ assetsItem, transactionsToggle }: AssetsItemProps) => {
  ...
  return coinData !== null ? (
    ...
    >
      ...
      <StyledTableCell align="center">
        <Box>
          <AssetsMenu transactionsToggle={transactionsToggle} coinId={id} coinTicker={ticker} />
        </Box>
      </StyledTableCell>
    </StyledTableRow>
  ) : (
